...
public class Tela_Busca_Cadastro extends JFrame {
	...
	public void editar(){
		System.out.println("Cheguei aqui... Tela de edi��o professor");
		JFrame f= new JFrame();
		f.setSize(200,200);
		f.setVisible(true);
		f.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
	...
	public void buscar(Conexao cnx){
		...
		if(rs != null){
			...
			System.out.printf("Sua consulta n�o produziu resultados!", 
					"Consultaitor");	
		}
	...
	public void confirmar(){
		...
		if (cnx.atualize(strAtualizar) > 0){
			JOptionPane.showMessageDialog(this, "Professor inclu�do com sucesso!", "Acad�mico", JOptionPane.INFORMATION_MESSAGE);
			setVisible(false);
			contentPane.setVisible(true);			
		}else{
			JOptionPane.showMessageDialog(this, "Falha ao incluir o professor!", "Acad�mico", JOptionPane.INFORMATION_MESSAGE);
		}
	}}
